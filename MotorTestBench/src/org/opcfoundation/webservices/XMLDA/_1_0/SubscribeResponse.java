...
public class SubscribeResponse  implements java.io.Serializable {
    ...
    private org.opcfoundation.webservices.XMLDA._1_0.SubscribeReplyItemList RItemList;
    ...
    public SubscribeResponse(
           ...
           org.opcfoundation.webservices.XMLDA._1_0.SubscribeReplyItemList RItemList,
     ...
     * @return RItemList
     */
    public org.opcfoundation.webservices.XMLDA._1_0.SubscribeReplyItemList getRItemList() {
        return RItemList;
    }
     ...
     * @param RItemList
     */
    public void setRItemList(org.opcfoundation.webservices.XMLDA._1_0.SubscribeReplyItemList RItemList) {
        this.RItemList = RItemList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.RItemList==null && other.getRItemList()==null) || 
             (this.RItemList!=null &&
              this.RItemList.equals(other.getRItemList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getRItemList() != null) {
            _hashCode += getRItemList().hashCode();
        }
        if (getErrors() != null) {
            for (int i=0;
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "SubscribeReplyItemList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
