...
public class InputPanel extends JPanel {
    ...
    //Variables panel
    public LabeledInput startTime = new LabeledInput("Tiempo de inicio [s]:");
    public LabeledInput stopTime = new LabeledInput("Tiempo de fin [s]:");
    public JTextField filename = new JTextField(40);
    public JButton startPlotButton = new JButton("Gráfico");
    ...
    
    {
        ...
        variablesPanel.add(startPlotButton);
        variablesPanel.add(saveCSVButton);
        startTime.set(variablesPanel);
