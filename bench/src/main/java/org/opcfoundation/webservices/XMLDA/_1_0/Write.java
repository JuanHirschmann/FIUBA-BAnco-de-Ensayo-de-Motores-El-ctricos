...
public class Write  implements java.io.Serializable {
     ...
     * @return itemList
     */
    public org.opcfoundation.webservices.XMLDA._1_0.WriteRequestItemList getItemList() {
        return itemList;
    }
     ...
     * @param itemList
     */
    public void setItemList(org.opcfoundation.webservices.XMLDA._1_0.WriteRequestItemList itemList) {
        this.itemList = itemList;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "WriteRequestItemList"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
