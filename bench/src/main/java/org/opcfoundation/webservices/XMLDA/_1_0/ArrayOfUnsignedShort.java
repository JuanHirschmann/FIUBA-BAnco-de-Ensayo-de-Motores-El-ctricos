...
public class ArrayOfUnsignedShort  implements java.io.Serializable {
    ...
    public ArrayOfUnsignedShort(
           org.apache.axis.types.UnsignedShort[] unsignedShort) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ArrayOfUnsignedShort)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.unsignedShort==null && other.getUnsignedShort()==null) || 
    ...
    public synchronized int hashCode() {
        ...
        if (getUnsignedShort() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getUnsignedShort());
                 i++) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ArrayOfUnsignedShort.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "ArrayOfUnsignedShort"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("unsignedShort");
        elemField.setXmlName(new javax.xml.namespace.QName("http://opcfoundation.org/webservices/XMLDA/1.0/", "unsignedShort"));
